...
Процедура ЗагрузкаПозицииПриАктивизацииСтроки(Элемент)
	...
	И Объект.Вид = "Источник" И Не ПустаяСтрока(Объект.Тема)
...
Процедура ОбновитьВидимостьДоступность(Форма)
	...
	Форма.Элементы.СтраницаПрием.Видимость = (Форма.Объект.Вид="Источник");
	Форма.Элементы.СтраницаОтправка.Видимость = (Форма.Объект.Вид="Приемник");
